...
export class Logs_AdmService {
  ...
  getLogs(): Observable<AuditLog[]> {
    return this.http.get<AuditLog[]>(`${this.url_back}/admin/logs`);
  }

  getSystemUpdates(): Observable<SystemUpdateResponse> {
    return this.http.get<SystemUpdateResponse>(`${this.url_back}/admin/system-updates`);
  }
